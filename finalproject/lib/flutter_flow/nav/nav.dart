...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const SigninSignupWidget() : const BrowsePostWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ...
              : const BrowsePostWidget(),
        ),
        FFRoute(
          name: 'BrowsePost',
          path: '/browsePost',
          builder: (context, params) => const BrowsePostWidget(),
        ),
        FFRoute(
          name: 'NewPost',
          path: '/newPost',
        ...
        FFRoute(
          ...
          path: '/postDetail',
          asyncParams: {
            'postid': getDoc(['UserPosts'], UserPostsRecord.fromSnapshot),
          },
